          ...
          >
            ...
            >
              <Link
                href="/#contact"
                onClick={() => setIsMenuOpen(false)}
                className="block w-full rounded-2xl border border-black/10 bg-black px-6 py-4 text-center text-lg text-white font-semibold shadow-lg shadow-black/20 transition-all duration-300 hover:bg-black/90"
              >
                <motion.span
                  className="absolute inset-0 bg-gradient-to-r from-transparent via-white/15 to-transparent opacity-0"
                  initial={{ scale: 1 }}
